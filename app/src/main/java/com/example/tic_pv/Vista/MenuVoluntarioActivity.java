...
public class MenuVoluntarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout btnVerInformacion = findViewById(R.id.btnVerInformacionVoluntario);
        btnVerInformacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MenuVoluntarioActivity.this, VerInformacionPerfilActivity.class);
